    ...
    try {
        ...
        if(jacket.on_sale){
            ...
            <div class="specific-jacket-item">
                ...
                alt="${jacket.description}" style="border-radius: 5px;"/>
            </div>
            ...
            <form class="jacket-form"> 
               ...
               <p class="p-bold" style="text-decoration: line-through; color: gray">WAS £${jacket.prices.regular_price}</p>
               <p class="p-bold" style="color: white; background-color: red; border-radius: 5px;">NEW PRICE £${jacket.prices.price}</p>
            </form>
            ...
            <section class="cart">
                <div class="addedtocart_popup">
                    ...
                    <div class="popup-content3">
                        ...
                        <p class="p-bold-price" style="color: red"> £${jacket.prices.price}</p>
                        <hr class="hr-pop"></hr>
                        <a href="jacket_page.html?id=${jacket.id}"><input type="submit" value="Close" class="continue_shopping"></a>
